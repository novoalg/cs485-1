...
StaticText.create(page: "static_pages/index", location: "panel4", title: "Fun Consumables", text: "We offer a wide variety of tasy treats, from snacks and dips to handmade candy.")
