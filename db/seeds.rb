...
PageSection.create(page: "static_pages/index", section: "description", text: "Silver & Stones Gallery is the perfect place to shop for special gifts or treasures for your home. We pride ourselves on our large collection of locally produced artwork, artisan-made jewelry, and fine decor. We stock many specialty items that you won't be likely to find anywhere else! Our friendly staff and warm, welcoming store environment ensure an enjoyable shopping experience.")
PageSection.create(picture: File.open(File.join(Rails.application.root.to_s, '/app/assets/images/static_pages/logo_instore.jpg')), page: "static_pages/about", section: "first box", title: "Local and Proud", text: "We're locally and family owned, so we don't have to compromize on quality. There are few better places to live than Eau Claire. The area is vibrant and full of creative people! The creative attitude drives us, and we are proud to offer a sampling of the region's finest works!")
PageSection.create(picture: File.open(File.join(Rails.application.root.to_s, '/app/assets/images/static_pages/about_us.jpg')), page: "static_pages/about", section: "second box", title: "Our Passion", text: "We love what we do.")
PageSection.create(picture: File.open(File.join(Rails.application.root.to_s, '/app/assets/images/static_pages/storefront.jpg')), page: "static_pages/about", section: "header", title: "Learn a little bit about us!", text: "We hope that you will find our service to your liking. We're proud of where we've been and remain proud of where we're going. Hopefully, our future involves you!")
PageSection.create(page: "static_pages/contact", section: "blurb", title: "Get In Touch!", text: "We would love to hear from you. You can reach out to us and one of our team members will get back to you as soon as possible. Otherwise, you're welcome to call or stop in - we'd be more than happy to help you in person!")
