...
StaticText.create(page: "static_pages/index", location: "panel1", title: "Home Accents", text: "We get new items in frequently, so there will always be something new and interesting to enjoy in your home!")
StaticText.create(page: "static_pages/index", location: "panel2", title: "Artisan Jewlery", text: "Our stock of artisan jewelry is of the finest quality, produced by masters of their trade.")
StaticText.create(page: "static_pages/index", location: "panel3", title: "Unique Apparel", text: "If you've got an eye for fashion, you know how important a unique style is. We have apparel you won't find anywhere else!")
StaticText.create(page: "static_pages/index", location: "panel4", title: "Fun Consumables", text: "We offer a wide variety of tasty treats, from snacks and dips to handmade candy.")
StaticText.create(page: "static_pages/index", location: "panel5", title: "Fantastic Gifts",text: "Sometimes it can be hard to find a unique gift. Our unique stock means you're sure to find that special something.")
StaticText.create(page: "static_pages/index", location: "panel6", title: "Beautiful Art", text: "Our artists provide some of their best work for us, which we're happy to pass along to you.")
